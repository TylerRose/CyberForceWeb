...
namespace CyberForceWeb.Web.Api
{
    ...
    {
        protected CyberForceWeb.Data.Services.ILoginService Service { get; }

        public LoginServiceController(CyberForceWeb.Data.Services.ILoginService service)
        {
            Service = service;
        }
        ...
        public virtual async Task<ItemResult<UserInfoDtoDtoGen>> GetUserInfo()
        {
            ...
            _result.Object = Mapper.MapToDto<CyberForceWeb.Data.Dto.UserInfoDto, UserInfoDtoDtoGen>(_methodResult.Object, _mappingContext, includeTree);
            return _result;
        }
    }
}
