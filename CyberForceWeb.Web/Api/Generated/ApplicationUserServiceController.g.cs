...
namespace CyberForceWeb.Web.Api
{
    ...
    {
        protected CyberForceWeb.Data.Services.IApplicationUserService Service { get; }

        public ApplicationUserServiceController(CyberForceWeb.Data.Services.IApplicationUserService service)
        {
            Service = service;
        }
        ...
        public virtual async Task<ItemResult<System.Collections.Generic.ICollection<UserInfoDtoDtoGen>>> GetAllUsersInfo()
        {
            ...
            _result.Object = _methodResult.Object?.ToList().Select(o => Mapper.MapToDto<CyberForceWeb.Data.Dto.UserInfoDto, UserInfoDtoDtoGen>(o, _mappingContext, includeTree)).ToList();
            return _result;
        }
